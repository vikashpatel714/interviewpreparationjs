...
//   document.querySelector("h1").style.color = "green";
  ...
  //* 4. Create an HTML page having content as Hello world and a button named Replace Text. When user will click on this button page content should be changed to "Welcome to HOME" .
